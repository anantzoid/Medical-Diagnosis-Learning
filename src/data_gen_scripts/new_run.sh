...
# TOP 10
#stdbuf -oL python ../preprocess.py --data '/misc/vlgscratch2/LecunGroup/laura/medical_notes/processed_data' --ICDcodelength 5 --notestypes 'discharge summary' --notescontent 2 --generatesplits 0 --numlabels 10 --firstK 1 --preprocessing 'add space,remove brackets,replace numbers,replace break' --procdatafile 10codesL5_UNK_content_2_top1 --mapunk 0 2>&1 --generatesplits 1 | tee datagen_10codesL5_UNK_content_2_top1.log
