...
get_data_stats(data)
_ = get_top_diagnoses(data, num_labels)
print()
...
_ = count_labels(data, num_labels)
...
_ = count_labels(train_data, num_labels)
_ = count_labels(valid_data, num_labels)
_ = count_labels(test_data, num_labels)
